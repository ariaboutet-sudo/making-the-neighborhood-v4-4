  ...
  },
{
  ...
  description: "description: "Founded in 1974 by artists Joe Overstreet and Corrine Jennings and writer Samuel C. Floyd, Kenkeleba House created cultural infrastructure for Black artists largely excluded from New York’s mainstream art institutions. Beginning as an interdisciplinary project space on the Bowery, Kenkeleba developed into a six-story East 2nd Street building that its founders and associates rehabilitated through sweat equity, combining exhibition space with studios and working space for artists. Its early programming crossed disciplines—visual art, poetry, music, dance, theater, children’s programs, workshops, and African markets—while supporting African American, African, and Caribbean artists in developing, exhibiting, and documenting their work. Kenkeleba later expanded its mission to other artists marginalized by the mainstream art world, while maintaining the preservation and development of African and African American cultural production at its center. More than a gallery, Kenkeleba functioned as artist-built cultural infrastructure: creating the space, resources, community, and institutional support that the established art world routinely denied Black artists.",",
  quote: "",
