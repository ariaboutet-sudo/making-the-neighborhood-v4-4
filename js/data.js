...

{
 ...
 slides: [
...
},
  {
    ...
    description: "CHARAS was a Puerto Rican–led neighborhood organization founded in 1965 by Carlos “Charlie” Torres, Humberto Soto, Angelo González, and Armando Pérez, whose first names gave the organization its name (CHArlie, RAmando, Soto). Responding to disinvestment and abandonment, CHARAS built an ecosystem of community-controlled institutions across the Lower East Side. The organization played a central role in the emerging homesteading movement by mobilizing residents, organizing collective rehabilitation projects, and building the neighborhood networks that made sweat-equity housing possible, while collaborating with technical and legal partners to return abandoned buildings to safe, resident-controlled use. Its work also included youth and arts programs, recycling initiatives, experiments with geodesic domes as a potential affordable housing model, and community gardens including La Plaza Cultural. Many of the same organizers later founded Loisaida, Inc., a community development organization that grew out of CHARAS’s work. In 1979, CHARAS transformed the abandoned P.S. 64 building into El Bohío, a community and cultural center that became its headquarters and one of the neighborhood’s most important spaces for arts, education, organizing, and mutual aid until its closure in 2001. CHARAS was thus involved in many specific sites throughout the neighborhood, El Bohío represents only one (albeit extremely significant) site.",
    quote: "",
